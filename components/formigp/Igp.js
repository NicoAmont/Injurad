...
export default function Igp() {
  ...
  return (
    <div className="bg-bgr  pt-32 md:pt-40 pb-20">
        ...
        <div className="w-full md:w-3/4 m-auto h-auto md:h-auto  mb-10  relative items-end align-bottom overflow-hidden">
                    
            
            <div className="w-full  m-auto mb-8">
                <h2 className=" text-bg2 font-medium text-left text-lg pt-5 px-4 md:px-0  ">{t("form_igp_tit2a")}</h2>
                <p className=" text-bg2 font-normal text-left text-normal pt-5  px-4 md:px-0">{t("form_igp_tit2b")}</p>
