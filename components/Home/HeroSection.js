                ...
                <ReactPlayer
                    ...
                    playIcon={  
                                <div className="w-screen h-screen  relative z-20 m-auto" >
                                        <Image className='absolute h-screen  bottom-0 z-20 '  src={poster} layout='fill' objectFit='cover' objectPosition='center' alt="" />    
                                        <svg className="w-5/12 sm:w-32 videoh2 sm:videoh absolute left-0 top-0 z-30 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 " viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
