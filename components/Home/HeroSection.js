...
export default function HeroSection() {
    ...
    return (
        ...
        <div className="w-full h-screen font-heads bg-bgf  relative flex flex-col ">
                <div className="w-auto h-screen md:w-full md:h-auto relative z-20 m-auto" >
                ...
                <ReactPlayer
                    ...
                    light
                    playing={ isPlaying }
                    playIcon={ <svg className="w-5/12 sm:w-1/12 " viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Image className='absolute h-full opacity-30 bottom-0 z-10 '  src={poster} layout='fill' width='100%' height='100%' objectFit='cover' objectPosition='center' alt="" />
