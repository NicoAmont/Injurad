    ...
    return (
        ...
        <div className="w-full h-auto md:videoh font-heads bg-bgf  relative flex flex-col ">
                ...
                <ReactPlayer
                    ...
                    playing={ isPlaying }
                    playIcon={  
                                <div className="w-screen videoh  relative z-20 m-auto" >
                                        <Image className='absolute h-full  bottom-0 z-20 '  src={poster} layout='fill' objectFit='cover' objectPosition='center' alt="" />    
                                        <svg className="w-5/12 sm:w-1/12 videoh2 sm:videoh relative z-30 m-auto mt-20 sm:mt-24 " viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
