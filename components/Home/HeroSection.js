...
export default function HeroSection() {
    ...
    return (
        ...
        <div className="w-full h-screen font-heads bg-bgf  relative flex flex-col ">
                ...
                <iframe className="relative mt-28 md:mt-36 z-10 w-screen m-auto h-3/4 scale-110  rounded-lg shadow-xl" src={ytvideo[0]} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
