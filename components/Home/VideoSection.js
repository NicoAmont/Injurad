        ...
        <div className=" m-auto bg-bgr font-heads relative  ">
            ...
            <div className="flex flex-col text-center justify-center m-auto w-3/4 md:w-full max-w-7xl py-20 px-4 relative h-full">
                ...
                <div className="w-full md:w-full pt-5 m-auto" >
                    <div className=" px-4  text-left mb-4 m-auto">
                        ...
                        <p className="mb-2 md:w-3/5 m-auto text-left text-lg">{t('info_pa')} <span className="font-bold text-bg2">{t('info_pc')}</span> {t('info_pc2')}</p>
                        <p className="mb-5 md:w-3/5 m-auto text-left  text-lg">{t('info_pd')}</p>
                    </div>
                </div>
                            ...
                            <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-left text-bg2">
                                <div className="w-full bg-bgr2 p-4">
                                    ...
                                    <div className="flex flex-row ">
                                        ...
                                        <p className="w-40 sm:w-full">{t("reason_qansw2g")}</p>
                                    </div>
            ...
            <div className="w-full m-auto mt-24  h-auto relative text-bgr segments segment-2 ">
                ...
                <div className="flex flex-col  relative w-full md:w-2/4 py-20 bg-gradient-to-b md:bg-gradient-to-r from-bg2 via-bg2  bg-opacity-25" >
                    ...
                    <button className=" m-auto bg-sl  text-bgr font-medium w-48 py-2 flex items-center justify-center mt-16 hover:bg-bg2 hover:border hover:border-sl transition-all duration-150">
                    {t("more2")}
