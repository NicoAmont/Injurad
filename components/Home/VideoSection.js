        ...
        <div className=" m-auto bg-bgr font-heads relative  ">
            ...
            <div className="w-full m-auto mt-24  h-auto relative text-bgr segments segment-2 ">
                ...
                <div className="flex flex-col  relative w-full md:w-2/4 py-20 bg-gradient-to-b md:bg-gradient-to-r from-bg2 via-bg2  bg-opacity-25" >
                    ...
                    <button className=" bg-sl  text-bgr font-medium w-48 py-2 flex items-center justify-center mt-16 hover:bg-bg2 hover:border hover:border-sl transition-all duration-150">
                    {t("more2")}
