            ...
            <div className="flex flex-col text-left justify-center m-auto w-3/4 md:w-full max-w-7xl py-20 px-4 relative  h-full">
                ...
                <h1 className="text-3xl text-bg2 sm:text-5xl text-left w-full  font-bold mb-10">{t('reason_tittle')} <span className="text-sl">{t('reason_tittlebold')}</span> </h1>
                    ...
                    <div className=" w-11/12 md:w-3/4 m-auto text-left font-normal  text-lg  p-4">
                        ...
                        <p className="font-normal tracking-wider  mb-5">{t('reason_tittleinfotit')}</p>
                        ...
                        <div className="flex flex-row ">
                            ...
                            <p className="w-60 sm:w-full mb-2">{t("reason_tittleinfotit4")}</p>
                        </div>
                ...
                <div className="w-full md:w-full pt-5 m-auto" >
                    <div className=" px-4  text-left mb-4 m-auto">
                        <h1 className="font-bold  text-3xl md:text-4xl md:w-4/5 m-auto  text-bg2  mb-10  ">{t('info_title')} </h1>
