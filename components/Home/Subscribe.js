            ...
            <div ref={ref} className="bg-bgr max-w-4xl mx-auto">
                ...
                <div className="flex-col mt-40">
                    <div className="flex flex-col sm:flex-row  h-full ">
                        <div className="max-w-lg mt-5 h-40 w-80 rounded-full flex place-content-center px-4">
                            <div className="h-28 w-80 flex items-center pt-6 relative">
                                <div className="border-8 border-bgr w-28 h-28 rounded-full absolute z-20 left-44 top-20">
                                    <Image className="border-2 border-bgr" src="/buyersub.png" width="90" height="90" alt="" />
                                </div>
                                <div className=" bg-none transition-all duration-200 ease-linear cursor-pointer border-bgr border-4  ml-2 hover: h-28 w-full rounded-full flex place-content-center ">
                                    <h1 className=" font-bold uppercase text-4xl text-bd ml-28 text-center">Comprador</h1>
                                    <div className="ml-4">
                        ...
                        <div className="max-w-md sm:ml-20 px-6 mt-4 sm:mt-0" >
                                <ul>
                                    ...
                                    <li className="mt-12"><span className="text-subs2 font-bold">Descripción detallada</span>  para coincidencias mas detalladas.</li>
                                    <li><span className="text-subs2 font-bold">Destaca</span> tu perfil llamando la atención de los vendedores como hot lead (ready to buy). </li>
                    ...
                    <div className="flex flex-col sm:flex-row mt-20  h-full pb-10">
                        <div className="max-w-md sm:ml-20 mt-4 sm:mt-0 px-6">
                                <ul>
                                    ...
                                    <li>Cinco <span className="text-subs2 font-bold">propiedades exclusivas</span> durante tres meses más una propiedad gratis </li>
                                    <li>Diez <span className="text-subs2 font-bold">propiedades exclusivas</span> durante tres meses más una propiedad gratis </li>
                                    <li><span className="text-subs2 font-bold">Prórroga gratuita</span>Prórroga gratuita hasta que otro vendedor quiere ofrecer la propiedad en caso tu no renuevas la inscripción </li>
                                    <li><span className="text-subs2 font-bold">Publicar logo</span> en la oferta</li>
                                    <li><span className="text-subs2 font-bold">Publicar fotos</span></li>
                                    <li><span className="text-subs2 font-bold">Enlace a la pagina web </span>donde se encuentra la casa </li>
                                </ul>
                        ...
                        <div className="max-w-lg mt-5 h-40 w-80 rounded-full flex place-content-center px-4">
                            <div className="h-28 w-80 flex items-center pt-20 relative sm:pr-10">
                                <div className="border-8 border-bgr w-28 h-28 rounded-full absolute z-20 left-40 top-44">
                                    <Image className="border-2 border-bgr" src="/sellersub.png" width="116" height="116" alt="" />
                                </div>
                                <div className="  bg-none transition-all duration-200 ease-linear cursor-pointer border-bgr border-4  ml-2 hover: h-28 w-full rounded-full flex place-content-center ">
                                    <h1 className=" font-bold uppercase text-4xl text-bd text-center ml-28 mt-10">Inmobiliaria </h1>
                                    <div className="ml-4">
                    ...
                    <div className="flex flex-col sm:flex-row mt-20 ">
                        ...
                        <div className="max-w-lg mt-5 h-40 w-80 rounded-full flex place-content-center px-4">
                            <div className="h-28 w-80 flex items-center pt-1 relative">
                                <div className="border-8 border-bgr w-28 h-28 rounded-full absolute z-20 left-40 top-24">
                                    <Image className="border-2 border-bgr" src="/sellersub2.png" width="116" height="116" alt="" />
                                </div>
                                <div className="  bg-none transition-all duration-200 ease-linear cursor-pointer border-bgr border-4  ml-2 hover: h-28 w-full rounded-full flex place-content-center ">
                                    <h1 className=" font-bold uppercase text-4xl text-bd text-center ml-28 mt-10">Vendedor</h1>
                                    <div className="ml-4">
