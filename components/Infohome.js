export default function Infohome() {
    return (
        <div className="bg-gradient-to-b from-thome to-thome2 w-full relative z-10 h-screen" >
            <div className="block max-w-xl mx-auto text-center pt-28 items-center justify-center relative z-10 px-4 text-bd">
                ...
                <button className="rounded-lg px-8 py-2 shadow-lg uppercase mt-24 lg:text-bd text-bgr lg:bg-bgr bg-bd hover:scale-105 transition-all duration-1000 ease-out">unete</button>
