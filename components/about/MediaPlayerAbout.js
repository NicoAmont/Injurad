...
export default function MediaPlayerAbout() {
    ...
    return (
        ...
        <div className="w-full h-auto sm:h-screen md:videoh font-heads bg-bgf flex flex-col sticky top-0">
                ...
                <ReactPlayer
                    ...
                    playing={ isPlaying }
                    playIcon={  
                                <div className="w-screen h-96 sm:h-full  relative z-20 m-auto" >
                                        <div className="w-full h-full relative z-20 bg-bg2 bg-opacity-40"></div>
                                        <Image className='absolute h-full  bottom-0 z-10 '  src={poster} layout='fill' objectFit='cover' objectPosition='center' alt="" />    
