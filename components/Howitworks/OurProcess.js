        ...
        <div className="w-full h-full max-w-4xl m-auto flex-row">
            ...
            <div className=" w-11/12 px-2 sm:px-0 text-bgr mx-auto place-items-center ">
                    <Tab.Group >
                        ...
                        <Tab.List className="flex flex-wrap h-auto sm:w-3/4 sm:h-16 m-auto  ">
                            <Tab as={Fragment}>
                            {({ selected }) => (
                                <button
                                className={
                        ...
                        <Tab.Panels className=" h-auto sm:h-auto m-auto content-div3   p-8 md:p-10 sm:w-4/5 bg-bgr rounded-lg mb-20 shadow-2xl flex flex-col relative">
                        <svg className="w-10 md:w-20 absolute bottom-20 md:bottom-10 right-5 md:right-10"  viewBox="0 0 34 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <Tab.Panel>
                                ...
                                <div className="text-base font-normal text-bgr mt-5 ml-4 ">
                                    ...
                                    <h1 className="font-medium text-sl ml-2 leading-8 text-xl mt-4">{t('stepform1b')} </h1>
                                </div>
                            ...
                            <div className="text-4xl md:text-4xl font-bold text-sl m-auto flex ">
                                ...
                                <div className="text-base font-normal text-bgr mt-5 ml-4 ">
                                    ...
                                    <h1 className="font-medium mt-2 ml-2 leading-8 text-lg text-sl">{t('stepform2b')} </h1>
                                </div>
                            ...
                            <div className="text-4xl md:text-4xl font-bold text-sl m-auto flex ">
                                ...
                                <div className="text-base font-normal text-bgr mt-5 ml-4 ">
                                    ...
                                    <h1 className="font-medium mt-2 ml-2 leading-8 text-lg text-sl">{t('stepform4bb')} </h1>
                                </div>
                                <Link  href="/formigp" passHref>
                                <button className="bg-sl text-bgr w-48 py-2 flex items-center justify-center mt-10 hover:bg-bgf transition-all duration-150 relative z-10 ml-4">
                                    {t('more')}
