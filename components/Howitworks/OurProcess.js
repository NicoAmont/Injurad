  ...
  return (
    <div className="w-screen h-full relative flex flex-col bg-bgr">
        ...
        <div className="w-full h-full max-w-4xl m-auto flex-row">
                ...
                <div className="w-full h-full grid grid-flow-col ">
                    ...
                    <div className="relative ml-10" >
                        ...
                        <div className="w-96 h-16 rounded-xl border ml-4 mt-16  my-auto border-bgr2  flujo_cuadro grid place-items-center">
                            <p className="text-bg2 font-semibold text-base">{t("how_flujo_b7")}</p>
                        </div>
                        <div className="w-96 h-16 rounded-xl border ml-4 mt-16  my-auto border-bgr2 flujo_cuadro grid place-items-center">
                    ...
                    <div className="m-auto ml-4 relative">
                        ...
                        <div className=" absolute bottom-24 right-56 w-80 h-20 rounded-xl border ml-4 mt-5   my-auto border-bgr2  flujo_cuadro grid place-items-center">
                            <p className="text-bg2 font-semibold p-4 text-base">{t("how_flujo_b12")} <br /> {t("how_flujo_b11")} </p>
                        </div>
            ...
            <div className=" w-11/12 px-2 sm:px-0 text-bgr m-auto md:mx-auto ">
                    <Tab.Group>
                            ...
                            {({ selected }) => (
                                ...
                                <div className="flex w-full h-full m-auto mr-11  px-3 relative">
                                    ...
                                    <div className="w-full h-full relative z-10 ">
                                        ...
                                        <h1 className="text-xl md:text-2xl absolute bottom-0 w-20 ">{t('step')} <span className="font-semibold">1</span> </h1>
                                    </div>
                                </div>
                            ...
                            {({ selected }) => (
                                ...
                                <div className="flex w-full h-full m-auto  px-2">
                                    ...
                                    <div className="w-full h-full relative z-10 ">
                                        ...
                                        <h1 className="text-xl md:text-2xl absolute bottom-0">{t('step')} <span className="font-semibold">2</span></h1>
                                </div>
                                </div>
                            ...
                            {({ selected }) => (
                                ...
                                <div className="flex w-full h-full m-auto  px-3">
                                    ...
                                    <div className="w-full h-full relative z-10 ">
                                        ...
                                        <h1 className="text-xl md:text-2xl absolute bottom-0">{t('step')} <span className="font-semibold">3</span></h1>
                                </div>
                                </div>
