    ...
    return (
        ...
        <div className="w-full h-screen font-heads bg-bgrS  realtive flex flex-col ">
            ...
            <div className=" w-screen flex flex-col items-center lg:items-start align-top text-center lg:text-left relative text-bgr font-bold m-auto z-10 lg:left-14 tracking-widest top-1/3 max-w-7xl" >
                ...
                <h1 className="text-3xl sm:text-8xl uppercase  text-sl">{t('hero_titleb')}</h1>  
                <h1 className="text-4xl sm:text-7xl uppercase ">{t('hero_titlec')}  <span className="text-4xl sm:text-8xl text-sl">{t('hero_titled')}</span> </h1> 
                <h1 className="text-base sm:text-xl font-light mt-4 px-1 ">{t('hero_subtitle')}</h1>
