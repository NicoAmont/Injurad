...
export default function FormDoc() {
    ...
    async function onSubmitForm(values) {
        ...
        let config2 = {}
        let conditionPriceCCyCD = values.step_process.includes("169,4")
        let conditionPriceCCyCD2 = values.step_process.includes("211,75")
        ...
        <div className="grid xl:grid-cols-2 xl:gap-6">
            ...
            <div className="relative z-0 mb-6 w-full group">
                    <input 
                        ...
                        id="pasaporte" 
                        className="block py-2.5 px-0 w-full text-base text-gray-900 bg-transparent border-0 border-b-2 border-bg2 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer bg-bgrS2 bg-opacity-10" 
                        placeholder=" " 
                        required 
                    />
                    <label 
