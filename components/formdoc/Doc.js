    ...
    <div className="bg-bgr  pt-20 md:pt-40 pb-20">
        ...
        <div className="w-3/4 m-auto mb-20 text-xl flex flex-col">
            ...
            <div className="w-full flex flex-wrap m-auto gap-20 items-center mt-5 md:pl-6">
                ...
                <div className="relative bg-bg2 z-10  w-full md:w-8/12 m-auto mt-20 h-auto pb-16 md:pb-5 md:h-auto shadow-2xl rounded-xl items-end align-bottom ">
                    ...
                    <div className="w-3/4 m-auto mt-4 ">
                        ...
                        <div className="w-96"  >
                        <Menu >
                            <Menu.Button className="relative mb-6  w-auto px-5 py-1 rounded-lg z-10 bg-sl m-auto text-sm  text-bgr font-base text-left  italic"><p clasName="m-auto w-10 overflow-hidden h-10">{t("form_doc_")}</p> </Menu.Button>
