            ...
            <div className="flex items-center text-base w-full h-28 px-5 lg:px-20 justify-between">
                ...
                <div className="hidden lg:inline-flex w-full text-sm lg:text-base">
                    ...
                    <div className="flex justify-center flex-grow font-heads font-normal   ">
                        <div className="flex place-items-center  cursor-pointer lg:px-10 uppercase text-bl transition-colors ">
                            <Link  href="/" passHref><div className="flex flex-col place-items-center text-center justify-center w-24 h-28 hover:bg-thome2">
                                ...
                                <path d="M25.3191 12.2193V25.0798H17.378V17.2842H12.9729V25.0798H4.68164V12.2193L15.0004 4.28223L25.3191 12.2193Z" fill="#37497b"/>
                                <path d="M25.7511 8.27086V2.83166H21.4054V4.92768L15 0L0 11.5395L3.14256 15.6242L15 6.50273L26.8574 15.6241L30 11.5395L25.7511 8.27086Z" fill="#37497b"/>
                                <path d="M25.3187 12.2193V25.0798H17.3776V17.2842H15V4.28223L25.3187 12.2193Z" fill="#37497b"/>
                                <path d="M30 11.5395L26.8574 15.6242L15 6.50273V0L21.4054 4.92768V2.83166H25.7511V8.27086L30 11.5395Z" fill="#37497b"/>
                                </svg>
                                <a className=" transition-colors delay-150 text-sm font-norma text-subs2l text-subs2">inicio</a>
                            </div></Link>
                    ...
                    <div className="flex ">
                        ...
                        <Link  href="/"><button className="hover:bg-thome2 border-none border-bl  hover:border-bl hover:transition-colors hover:delay-75 hover:ease-linear font-base hover:shadow-lg flex uppercase  rounded px-6 py-1.5 w-100 text-subs2">
                ...
                <div className="md:hidden flex relative right-0 hover:text-subs2">
                    <svg width="28" height="30" viewBox="0 0 66 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0 26C0 23.2386 2.23858 21 5 21H61C63.7614 21 66 23.2386 66 26V72H0V26Z" fill="#37497b"/>
                        <path d="M27.7347 3.08194C31.1118 1.17112 35.2459 1.1809 38.6139 3.10767L60.9656 15.8946C64.079 17.6757 66 20.9878 66 24.5746V31H0V25.1894C0 21.2253 2.13291 17.5678 5.58304 15.6157L27.7347 3.08194Z" fill="#37497b"/>
